...
!$      timer = omp_get_wtime() 
	...
	call cpu_time_init(16,'time spent in scalar init       :')
	call cpu_time_init(17,'time spent in scalar stability  :')
	call cpu_time_init(18,'time spent in scalar loop       :')
	call cpu_time_init(19,'time spent in scalar mass check :')
	call cpu_time_init(20,'time spent in scalar element    :')
	call cpu_time_init(21,'time spent in scalar node       :')
	call cpu_time_init(22,'time spent in scalar tvd        :')
	call cpu_time_init(23,'time spent in scalar flux       :')
	call cpu_time_init(24,'time spent in scalar conz3d     :')
	call cpu_time_init(25,'time spent in scalar after      :')
